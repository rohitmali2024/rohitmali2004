...
const Achievements = () => {
  ...
  const stats = [
    { label: 'GeeksforGeeks', value: '100+', platform: 'rohiitttt_19' },
    { label: 'LeetCode', value: '80+', platform: 'rohitmali28' },
    { label: 'CodeChef', value: '70+', platform: 'rohiitttt_19' },
    { label: 'HackerRank', value: '50+', platform: 'rohit_mali' }
  ];
