...
//       name: 'LinkedIn',
//       username: 'Rohit Mali',
//       href: 'https://www.linkedin.com/in/rohit-mali-6b4706255?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app',
...
//       href: 'https://www.geeksforgeeks.org/user/rohiitttt_19/',
...
//       href: 'https://leetcode.com/u/rohitmali28/',
...
const Contact = () => {
  ...
  return (
    <section id="contact" className="py-16 sm:py-20 bg-gray-900/30 px-4">
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12">
          <div className="space-y-8">
            ...
            <Card className="bg-gray-800/50 border-gray-700 backdrop-blur-sm">
              <CardHeader>
                <CardTitle className="text-xl sm:text-2xl text-white">Social Links</CardTitle>
              </CardHeader>
              <CardContent>
